...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practices and games for basketball enthusiasts",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["mason@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim workouts and competitions in the school pool",
    ...
    "Debate Team": {
        "description": "Practice critical thinking and public speaking for debates",
